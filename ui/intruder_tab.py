...
class IntruderTab (ttk .Frame ):
    ...
    def _build (self ):
        ...
        self ._req_text =tk .Text (req_frame ,height =8 ,wrap ="none",bg ="#0A0B10",fg ="#E8DCC8",
        font =("Consolas",9 ))
        ...
        self ._payload_text =tk .Text (payload_frame ,wrap ="none",bg ="#0A0B10",fg ="#aaffaa",
        font =("Consolas",9 ))
        ...
        bg ="#0A0B10",fg ="#E8DCC8",font =("Consolas",9 ),state ="disabled")
